...
question_list.append(Question('Самая большая страна в мире', 'Россия', 'Канада', 'США','Австрия'))
question_list.append(Question('В каком году родился А.С.Пушкин','1799', '1750', '1820','1234'))
question_list.append(Question('В каком году Германия вторглась в СССР', '1941', '1939', '1940', '1938'))
question_list.append(Question('Когда началась вторая мировая война','1939', '1941', '2012','1938'))
app = QApplication([])
...
def check_answer():
    ...
    if answers[0].isChecked():
        ...
        window.score += 1
        print('Статистика \n- Всего вопросов:', window.totle, '\n - Правильных ответов:', window.score)
        print('Рейтинг', (window.score / window.totle * 100, '%'))
    else:
